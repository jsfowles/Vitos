...
class MainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create main" do
    assert_difference('Main.count') do
      post mains_url, params: { main: { string: @main.string, time: @main.time, update: @main.update } }
    end
  ...
  test "should update main" do
    patch main_url(@main), params: { main: { string: @main.string, time: @main.time, update: @main.update } }
